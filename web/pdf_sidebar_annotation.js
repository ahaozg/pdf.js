...
const SIDEBAR_WIDTH_VAR = "--sidebar-annotation-width";
...
class PDFSidebarAnnotation {
  ...
  constructor({ elements, eventBus, l10n }) {
    this.isOpen = false;
    this.active = SidebarAnnotationView.LIST;
    this.isInitialViewSet = false;
    this.isInitialEventDispatched = false;

    /**
     * Callback used when the sidebar has been opened/closed, to ensure that
     * the viewers (PDFViewer) are updated correctly.
     */
    this.onToggled = null;
  ...
  reset() {
    ...
    this.switchView(SidebarAnnotationView.LIST);
   ...
   */
  get visibleView() {
    return this.isOpen ? this.active : SidebarAnnotationView.NONE;
  }
   ...
   */
  setInitialView(view = SidebarAnnotationView.NONE) {
  ...
  open() {
    ...
    this.outerContainer.classList.add(
      "sidebarAnnotationMoving",
      "sidebarAnnotationOpen"
    );
  ...
  close(evt = null) {
    ...
    this.outerContainer.classList.add("sidebarAnnotationMoving");
    this.outerContainer.classList.remove("sidebarAnnotationOpen");
  ...
  #dispatchEvent() {
    ...
    this.eventBus.dispatch("sidebarannotationviewchanged", {
      source: this,
  ...
  #addEventListeners() {
    this.sidebarContainer.addEventListener("transitionend", evt => {
      if (evt.target === this.sidebarContainer) {
        this.outerContainer.classList.remove("sidebarAnnotationMoving");
